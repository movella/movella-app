...
class NoFurnitureForRentWidget extends StatelessWidget {
  const NoFurnitureForRentWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        CustomErrorWidget(
          message:
              Localization.localize(context).youHaventPutAnyFurnitureForRentYet,
        ),
      ],
    );
  }
